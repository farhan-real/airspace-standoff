...
window.TEMPLATES_STRIKE = {
  'A-10C Close Air Support (Anti-Armor)': {
    ...
    desc: 'Armored bathtub CAS package using 9 of 10 stations (~5,310 kg • 74% HEAVY) combining dual 30mm Gatlings with 16 SDBs and SEAD.'
  },
  'A-10C Battlefield Interdiction': {
    ...
    desc: 'Maximum close air support bomb loadout using 8 of 10 stations (~4,840 kg • 67% HEAVY) with 16 SDBs and radar killers.'
  },
  'Su-25SM3 Armored Ground Attack': {
    ...
    upgrades: ['TITANIUM_COCKPIT', 'EXPANDED_CM_DISPENSER'],
    desc: 'Rugged titanium ground attacker using 8 of 10 stations (~5,350 kg • 79% HEAVY) with 16 SDBs, HARM radar killers, and ECM.'
  },
  'Su-25SM3 Low-Altitude SEAD': {
    ...
    desc: 'Low-altitude SAM radar suppression loadout using 7 of 10 stations (~6,140 kg • 90% OVERLOAD) carrying 8 anti-radiation HARMs.'
  },
  'Su-34 Tactical Strike Bomber': {
    ...
    upgrades: ['TITANIUM_COCKPIT', 'EXTENDED_RANGE_TURBO'],
    desc: 'Armored cockpit with 11 of 12 stations filled (~7,360 kg • 61% HEAVY) mounting stealth cruise missiles, HARMs, and radar jammers.'
  },
  ...
  'B-1B Low-Altitude Heavy Bombardment': {
    ...
    upgrades: ['TITANIUM_COCKPIT', 'EXTENDED_RANGE_TURBO'],
    desc: 'Variable-sweep supersonic bomber utilizing 12 of 14 stations (~8,040 kg • 45% NORMAL) deploying 4 cruise missiles and 16 glide bombs.'
  },
  'B-1B Strategic Standoff Carpet Interdiction': {
    name: 'B-1B Strategic Standoff Carpet Interdiction',
    specId: 'B-1B',
    roleCategory: 'STRIKE',
    chosenGunId: 'M61A2',
  ...
  'Tu-160M Strategic Standoff Bombardment': {
    ...
    upgrades: ['SUPERCRUISE_VCE', 'TITANIUM_COCKPIT'],
    desc: 'Heavy strategic package using 14 of 16 stations (~14,000 kg • 64% HEAVY) pairing Kinzhal hypersonic shock with 4 cruise missiles.'
  },
  'B-21 Long-Range Strike Bomber (LRS-B)': {
    ...
    desc: 'VLO flying-wing stealth penetrator using 12 of 16 stations (~8,040 kg • 54% NORMAL) carrying 4 cruise missiles and 16 SDBs.'
  },
  'B-2A Global Strike Penetrator': {
    ...
    desc: 'Heavy strategic stealth flying wing using 14 of 16 stations (~9,460 kg • 53% NORMAL) carrying 4 cruise missiles and 24 glide bombs.'
  }
};