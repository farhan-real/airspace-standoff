...
window.AI_DIFFICULTIES = {
  ...
  ACE: { name: 'High-Threat Grid', budgetCap: 460.0, scoreMultiplier: 2.00, reactionCooldown: 3.4, attentionSpanSec: 3.2, engagementRangeRatio: 0.74, evasionSkill: 0.44, blunderChance: 0.26, usesDopplerNotch: false, aceCount: 2, multiTarget: true, useAdvancedManeuvers: false },
  ...
  LEGEND: { name: 'Fortress Airspace', budgetCap: 660.0, scoreMultiplier: 3.20, reactionCooldown: 2.2, attentionSpanSec: 2.0, engagementRangeRatio: 0.90, evasionSkill: 0.60, blunderChance: 0.12, usesDopplerNotch: true, aceCount: 3, multiTarget: true, useAdvancedManeuvers: true }
};