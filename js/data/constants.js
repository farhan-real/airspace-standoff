...
window.AI_DIFFICULTIES = {
  CADET: { name: 'Low Threat Sector', budgetCap: 150.0, scoreMultiplier: 0.50, reactionCooldown: 7.2, attentionSpanSec: 5.5, engagementRangeRatio: 0.45, evasionSkill: 0.16, blunderChance: 0.62, usesDopplerNotch: false, aceCount: 0, multiTarget: false, useAdvancedManeuvers: false },
  VETERAN: { name: 'Contested Sector', budgetCap: 260.0, scoreMultiplier: 1.00, reactionCooldown: 5.8, attentionSpanSec: 4.8, engagementRangeRatio: 0.55, evasionSkill: 0.24, blunderChance: 0.46, usesDopplerNotch: false, aceCount: 1, multiTarget: false, useAdvancedManeuvers: false },
  ELITE: { name: 'High Threat Sector', budgetCap: 360.0, scoreMultiplier: 1.50, reactionCooldown: 4.4, attentionSpanSec: 4.0, engagementRangeRatio: 0.65, evasionSkill: 0.34, blunderChance: 0.35, usesDopplerNotch: false, aceCount: 1, multiTarget: false, useAdvancedManeuvers: false },
  ACE: { name: 'Severe Threat Sector', budgetCap: 460.0, scoreMultiplier: 2.00, reactionCooldown: 3.4, attentionSpanSec: 3.2, engagementRangeRatio: 0.74, evasionSkill: 0.44, blunderChance: 0.26, usesDopplerNotch: false, aceCount: 2, multiTarget: true, useAdvancedManeuvers: false },
  MASTER: { name: 'Air Defense Sector', budgetCap: 560.0, scoreMultiplier: 2.60, reactionCooldown: 2.8, attentionSpanSec: 2.6, engagementRangeRatio: 0.82, evasionSkill: 0.52, blunderChance: 0.18, usesDopplerNotch: true, aceCount: 2, multiTarget: true, useAdvancedManeuvers: true },
  LEGEND: { name: 'Hostile Airspace', budgetCap: 660.0, scoreMultiplier: 3.20, reactionCooldown: 2.2, attentionSpanSec: 2.0, engagementRangeRatio: 0.90, evasionSkill: 0.60, blunderChance: 0.12, usesDopplerNotch: true, aceCount: 3, multiTarget: true, useAdvancedManeuvers: true }
};