...
window.WEAPONS_PODS = {
  'SUU-23A': {
    ...
    behaviorDesc: '20mm 6-barrel Vulcan rotary cannon pod. Mounts on Western multirole, air superiority, and strike weapon pylons (0.85 HP burst, 2.8 HP/s).',
    damage: 2,
    damagePerBurst: 0.85,
    damagePerSec: 2.8,
    burstCooldown: 1.0,
  ...
  'SPPU-22': {
    ...
    behaviorDesc: 'Twin-barrel 23mm Gast-principle autocannon pod. Certified for Eastern strike, multirole, and air superiority hardpoints (0.80 HP burst, 2.4 HP/s).',
    damage: 2,
    damagePerBurst: 0.80,
    damagePerSec: 2.4,
    burstCooldown: 0.9,
  ...
  'GPU-5A': {
    ...
    behaviorDesc: 'Heavy 4-barrel 30mm rotary cannon pod. Mounts exclusively on dedicated CAS attackers, heavy strike bombers, and heavy missile trucks (1.4 HP burst, 3.4 HP/s).',
    damage: 2,
    damagePerBurst: 1.40,
    damagePerSec: 3.4,
    burstCooldown: 1.5,
  ...
  'PLSL_POD': {
    ...
    behaviorDesc: 'Dual coherent optical pulse laser emitter pod. Requires high-voltage avionics buses found on experimental superfighters and advanced 5th-Gen air dominance jets.',
    damage: 2,
    damagePerBurst: 0.95,
    damagePerSec: 2.8,
    burstCooldown: 1.8,
  ...
  'DE_POD': {
    ...
    behaviorDesc: 'High-energy solid-state thermal laser pod. Requires high-output turbine generators and heavy pylons on flagship superfighters and heavy air dominance platforms.',
    damage: 3,
    damagePerBurst: 1.60,
    damagePerSec: 3.6,
    burstCooldown: 2.2,
  ...
  'TLS_POD': {
    ...
    behaviorDesc: 'Direct speed-of-light thermal hitscan beam (3.0 HP damage, 24 shots) with 2.5s recharge cooldown. Zero lead time required; scattered by clouds.',
    damage: 3,
    damagePerBurst: 3.0,
    cooldown: 2.5,
    ammoCount: 24,
